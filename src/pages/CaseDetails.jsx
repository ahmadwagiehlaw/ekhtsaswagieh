                  ...
                  <div key={idx} className="w-full">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 gap-y-5 animate-in fade-in slide-in-from-top-2 duration-200">
                      {groupFields.map(field => {
                        ...
                        // Skip old text defendant fields if dynamic defendantsList exists
                        const hasDefList = (editData.defendantsList && editData.defendantsList.length > 0) || (caseData?.defendantsList && caseData.defendantsList.length > 0);
                        if (hasDefList && ['المدعى_عليه', 'المدعى عليه', 'الخصوم', 'عناوين المطعون ضدهم الآخرين'].includes(field.id)) return null;
