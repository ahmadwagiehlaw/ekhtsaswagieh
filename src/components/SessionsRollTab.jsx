            ...
            <div className="flex items-center gap-1 bg-slate-100 p-0.5 rounded-xl">
              {uniqueTypes.map(t => (
                <button
                  ...
                  className={`px-2.5 py-1 text-[10px] font-black rounded-lg transition-all ${sessionTypeFilter === t ? 'bg-navy-900 text-white shadow-sm' : 'text-slate-500 hover:text-slate-700 hover:bg-slate-200'
                    }`}
                >
                  {t}
                </button>))}
